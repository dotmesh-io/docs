...
Any time you interact with any part of dotmesh you are using the API. The `dm` command-line interface, any interaction between a local deployment and another cluster, all use the same, publicly-exposed dotmesh API.
